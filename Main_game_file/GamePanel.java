...
public class GamePanel extends JPanel {
                ...
                switch (e.getKeyCode()) {
                    ...
                    case KeyEvent.VK_I -> { // attack 
                        ...
                        if (rightHandItem instanceof Weapon || rightHandItem instanceof BowAndarow) {
                            ...
                            boolean enemyKilled = Main.performAttack(gamePlayer, player, dungeon);
    ...
    private void placeRandomItems() {
        ...
        // Place 3-5 random items on the floor
    ...
    private void drawControls(Graphics g) {
        ...
        y += lineHeight;
        g.drawString("R: to put current weapon on Right hand in Inventory", x, y);
        y += lineHeight;
        // y += lineHeight;
